...
const JobDetails = () => {
    ...
    const setLocalStorage = () => {
        ...
        const newData = [...previousData, job];
        ...
        <div>
            ...
            <div className=" max-w-screen-xl py-20 mlg:flex lg:justify-between mx-4">
                ...
                <div>
                    ...
                    <button
                        className="text-white py-2 px-4 rounded bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-blue-500 hover:to-cyan-500 mt-6 w-full"
